...
const App: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-mystical-black via-mystical-midnight to-mystical-deep-blue text-mystical-starlight overflow-x-hidden">
      {/* Background Effects */}
      <div className="fixed inset-0 pointer-events-none z-0">
        {/* Effet ondulaire paisible */}
        <div className="absolute inset-0 bg-gradient-to-br from-mystical-forest-dark/50 via-mystical-midnight to-mystical-black animate-wave-gentle"></div>
