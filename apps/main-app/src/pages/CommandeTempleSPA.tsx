            ...
            <div className="bg-gradient-to-br from-mystical-night/60 to-mystical-purple/40 backdrop-blur-md border border-mystical-gold/40 rounded-2xl p-6 shadow-spiritual relative overflow-hidden">
              ...
              <div className="mb-4 relative z-10">
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-white text-mystical-abyss placeholder-gray-500 border border-mystical-gold/40 rounded-lg focus:border-mystical-gold-light focus:outline-none focus:ring-2 focus:ring-mystical-gold/30 transition-all duration-500 tracking-wide"
                />
              </div>
