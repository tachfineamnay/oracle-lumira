      ...
      <div className="bg-slate-700/30 rounded-lg p-4 mb-6">
        ...
        {order.formData.specificQuestion && (
          <div className="mt-3 p-3 bg-slate-800/50 rounded">
            <span className="text-slate-400 text-xs">Question du client:</span>
            <p className="text-sm italic mt-1">"{order.formData.specificQuestion}"</p>
          </div>
        )}
          ...
          <div className="mt-3">
            ...
            <div className="mt-2 space-y-2">
              {order.files.map((file, index) => (
                <div key={index} className="flex items-center gap-2 text-xs bg-slate-800/30 p-2 rounded">
