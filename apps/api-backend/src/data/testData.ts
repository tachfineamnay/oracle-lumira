...
export const testOrders: TestOrder[] = [
  {
    ...
    details: {
      ...
      question:
        'Je traverse une période difficile dans ma vie professionnelle et j\'aimerais des conseils spirituels.',
  ...
  },
  {
    ...
    details: {
      ...
      question:
        'Questionnement global sur ma voie de vie et mes objectifs spirituels.',
  ...
  },
  {
    ...
    details: {
      ...
      question:
        'Je me sens perdue et j\'ai besoin de clarté sur ma direction spirituelle.',
